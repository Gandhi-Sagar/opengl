/* Demonstrates just enabling light, but not providing any material/lights
 * draws black objects. Can this be used as shadows is unknown.
 * This is a fourth exercise in the fifth chapter of superbible 4th edition
...
int main(int argc, char **argv) {
  ...
  glutCreateWindow("Black Jet - Lights enabled but not provided");
